...
if __name__ == '__main__':
    ...
    try:
        ...
        d_data = 0x91
        d_expected = "35"
        print(f"Test 1 - Key = {key1:>03X} Data = {e_data:>02X} Result = {encrypt(key1, e_data):>02X} Expected Result = {e_expected}")
        print(f"Test 1 - Key = {key1:>03X} Data = {d_data:>02X} Result = {decrypt(key1, d_data):>02X} Expected Result = {d_expected}")
    ...
    try:
        ...
        d_data = 0xEF
        d_expected = "7F"
        print(f"Test 2 - Key = {key2:>03X} Data = {e_data:>02X} Result = {encrypt(key2, e_data):>02X} Expected Result = {e_expected}")
        print(f"Test 2 - Key = {key2:>03X} Data = {d_data:>02X} Result = {decrypt(key2, d_data):>02X} Expected Result = {d_expected}")
